...
| 7.5"/5.83" V1, 7.5" HD | 640×384 … 880×528 | both | varies | `PANEL_75_B_V1` … | ⚪ compiles, untested |
...
Four signed examples live in [`registry/`](registry/) (Hacker News, crypto
price, air quality, GitHub stars) together with the signing tool and a
contribution guide. Spec, trust model and threat model: **[DESIGN.md](DESIGN.md)**.
...
a second workflow compiles genuine ESP32 binaries for every panel preset and
